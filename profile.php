...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h2>Меня зовут Костиков Владислав Александрович. Я начинающий специалист в области ИБ.
                    Я верю в будущее, в котором все люди защищены!</h2>
            </div>
            <div class="col-4">
                <div class="row my_photo"></div>
                <div class="row"><p class="title_photo">Костиков В.А.</p></div>
            </div>
        </div>
    </div>
    <div class="container">
